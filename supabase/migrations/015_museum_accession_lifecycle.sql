...
drop policy if exists "museum control is publicly readable" on public.museum_control;
create policy "museum control is publicly readable"
  on public.museum_control for select
  to anon, authenticated
  using (true);

revoke all on public.museum_control from public, anon, authenticated;
grant select (id, admission_open, museum_votes_per_accession, updated_at)
  on public.museum_control to anon, authenticated;
