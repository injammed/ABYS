...
AETIMM cannot become an enduring Slop Trough by avoiding slop.

It becomes resilient by transforming real uploads, real behavior, real edge cases, real bugs, and real iteration into stronger engineering.

Reality is the senior engineer.

We do not worship slop. We cultivate from it.
...
The website is the living artifact field.
...
The root experience must remain an uninterrupted, continuously loading field. Marketing copy, onboarding, settings, account management, upload controls, filters, provenance detail, and other nuanced tools must not stand between a visitor and the first artifact.

There is no terminal homepage footer in the primary field. Supporting explanations belong in supporting surfaces.
...
- Museum rooms;
- artifact journey and provenance;
- creator revision workspace;
- curator review;
- policy and project explanation.

Deep surfaces must provide an obvious return to the field. Where practical, the application should preserve the user's feed lane, artifact, and scroll position.

---

## Prohibitions

Do not place these before the first artifact:
...
- decorative controls;
- modal demands unrelated to safety or legal necessity.
...
History operates beneath them and makes the Museum possible.

Every interface fold must measurably strengthen at least one primary without weakening the others.
...
## September 2026: Apyoc — explicit fifth destination

The owner explicitly adds APYOC: UPLOAD · SCROLL · VOTE · SHOP · APYOC. Preserve the existing four actions and library. Apyoc v1 is a local trace-inspection prototype with evidence-linked deterministic rules, not a deployed autonomous or omniscient monitor. Its permanent observation directive is a product ambition. Continuous monitoring requires a separately instrumented backend and authorized sources.

## Apyoc priority — explicit owner revision, 12 September 2026

Apyoc is now the business priority. AETIMM is the funnel, public field, demonstrator of witnessed material and home of all eyes for one Apyoc. A compact Apyoc introduction and Eye link precede the uninterrupted root artifact stream; this explicitly supersedes the earlier ban on any root introduction. The root route is the Slop Feed. Its role is now the public field of Apyoc, not a claim that each submission has been independently observed or verified. No generated filler is permitted. The header prioritizes Apyoc, then Field and Museum. Primary actions are UPLOAD · SCROLL · VOTE · SHOP · APYOC. The gallery, purchase flow and account controls remain available.
