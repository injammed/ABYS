...
for (const [label, pattern, source] of [
  ...
  ["Museum collection uses one Artifact runtime", /<MuseumArtifactRuntime accession=\{accession\} \/>/, collection],
  ...
  ["Museum accession material register", /ACCESSION MATERIALS/, runtime],
  ["Museum fallback preserves accession existence", /The accession exists even when this browser has no native presentation for its form/, runtime],
]) {
...
console.log("Museum runtime PASS: accession preserves the complete Artifact envelope, native-safe forms remain experienceable, unsupported or executable forms stay sealed and retrievable, and Museum presentation never becomes another voting surface.");
