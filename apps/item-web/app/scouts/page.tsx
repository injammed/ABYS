...
export default function ScoutsPage(){return <main className={styles.page}><SiteHeader/><div className={styles.content}><header className={styles.scouts}><div><p className={styles.eyebrow}>AETIMM / LIBRARY SCOUTS</p><h1>Find what deserves a place.</h1><p>Scouts bring possibilities into view. Source inspection, independent judgment, and preservation come next.</p></div><Link href="/">Return to the library ↗</Link></header><p className={styles.description}>The scouts run without a language model. <a href="https://github.com/injammed/ABYS/tree/main/scripts/scouts" target="_blank" rel="noreferrer">Run a standalone scout on your own server ↗</a></p><LibraryReviews/><LibraryScouts/></div><PrimaryNavigation/></main>;}
