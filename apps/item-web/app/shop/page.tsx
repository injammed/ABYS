...
export const metadata: Metadata = {
  ...
  description: "Walk the global 3D+ currency library, read AETIMM editions, and support the work directly.",
};

export default function ShopPage() {
  return (
    <main className={`about-page ${styles.page}`} data-library-contract="literature-shelf-v2">
      <SiteHeader />
      <CurrencyMuseum />
      <div className={styles.content}>
        ...
        <article id="shop" className={styles.product} data-aetimm-item="0001" data-commerce-state="public">
          <figure className={styles.artwork}>
            ...
            <figcaption>AI CONCEPT ARTWORK · FINAL PAPER PUBLISHED BELOW</figcaption>
          </figure>
          <div className={styles.productCopy}>
            <p className="gallery-overline">ITEM 0001 / PUBLIC EDITION</p>
