  ...
  return (
    <main className={styles.page} data-interface-contract="aetimm-library-root-v1">
      ...
      <div className={styles.content}>
        ...
        <section className={styles.scouts} aria-labelledby="scouts-title"><div><p className={styles.eyebrow}>LIBRARY SCOUTS / SOURCE DISCOVERY</p><h2 id="scouts-title">Find what deserves a place.</h2><p>The first scout searches public GitHub projects for possible AI-made work. Inspect its source links and discovery signals. Quality, authorship, and preservation still require judgment.</p></div><Link href="/scouts/">Open the discovery desk ↗</Link></section>
