...
export function ApyocLedger(){
 ...
 return <section id="infrastructure-record" className={styles.observe} aria-labelledby="witness-title" data-apyoc-ledger="public-v1">
