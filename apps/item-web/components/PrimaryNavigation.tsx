...
export function PrimaryNavigation({ mode }: { mode?: "feed" | "museum" | "shop" | "apyoc" }) {
  return (
    <nav className="primary-navigation" aria-label="Upload, scroll, vote, shop, Apyoc" data-navigation-contract="upload-scroll-vote-shop-apyoc-v3">
      ...
      <div className="primary-action-rail">
        ...
        <Link href="/apyoc/" className="primary-action" aria-current={mode === "apyoc" ? "page" : undefined}>
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></svg><span>APYOC</span>
        </Link>
      </div>
    </nav>
  );
